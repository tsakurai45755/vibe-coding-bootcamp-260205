...
- **`docs/spec/requirements.md`**: User stories and acceptance criteria in structured EARS notation.
- **`docs/spec/design.md`**: Technical architecture, sequence diagrams, implementation considerations.
- **`docs/spec/tasks.md`**: Detailed, trackable implementation plan.
...
**Language Rule:**
All documentation artifacts (`requirements.md`, `design.md`, `tasks.md`) and templates should be generated in Japanese.
